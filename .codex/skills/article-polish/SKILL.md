...
name: article-polish
description: >-
  Rewrite and polish article copy for clarity and engagement. Use when Codex
  needs to improve wording, flow, tone, or readability without changing the core
  meaning.
invocable: true
prompt: >-
  Polish this blog post. Focus on the opening hook, paragraph transitions, and
  cutting redundancy:
...
output: content
system: >-
  You are ThomasLee's Blog editor. Polish drafts into publication-ready
  articles.
