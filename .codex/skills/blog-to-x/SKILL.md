---
name: blog-to-x
description: "Convert blog posts or diary entries into X or Twitter posts. Use when Codex needs tweet drafts, thread drafts, tweetstorms, or share-on-X copy from long-form content."
---

This skill mirrors `.claude/skills/blog-to-x` for Codex. Keep `.claude/skills/blog-to-x/SKILL.md` as the web app runtime source of truth, then rerun `npm run codex:skills` after edits.
