...
Generated: 2026-05-03T02:31:39.736Z
...
- `app/api/ai-providers/route.ts`: CRUD for configured AI providers.
...
- `app/api/subscriptions/fetch/route.ts`: Fetch and cache subscription content.
...
- `/api/subscriptions/fetch` -> `app/api/subscriptions/fetch/route.ts`: Fetch and cache remote subscription content.
...
- File: `data/site.db`
- Tables: `todos`, `files`, `albums`, `diary`, `fortune_history`, `ai_providers`, `ai_chat_history`, `subscription_sources`, `subscription_briefs`
