...
const API_ROUTE_DESCRIPTIONS = {
  ...
  '/api/ai-providers': 'List and manage configured AI providers.',
  '/api/ai-providers/[id]': 'Operate on a single AI provider.',
  ...
  '/api/subscriptions/fetch': 'Fetch and cache remote subscription content.',
  '/api/todos': 'Todo CRUD.',
